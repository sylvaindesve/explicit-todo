// https://gitlab.com/epinxteren/ts-eventsourcing/-/blob/master/src/EventStore/TypeOrm/Operator/fromQuery.ts
import { Observable, Observer } from "rxjs";
import { SelectQueryBuilder } from "typeorm";

function pageQuery<Entity>(
  ...
  return query
    ...
    .limit(itemPerPage)
    .getMany(); // sylvaindesve: Changed from `execute()`
}
 ...
 */
export function fromQuery<Entity>(
  query: SelectQueryBuilder<Entity>,
  entitiesPerPage = 500
): Observable<Entity> {
